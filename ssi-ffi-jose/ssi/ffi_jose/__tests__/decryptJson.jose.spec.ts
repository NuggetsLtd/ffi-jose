    ...
    describe('should decrypt JWE correctly', () => {
      ...
      describe('where enc type is `GCM`', () => {
        ...
        it("and `enc` = 'A128GCM'", async () => {
          const jwe = {
            protected: 'eyJhbGciOiJFQ0RILUVTK0ExMjhLVyIsImVuYyI6IkExMjhHQ00iLCJ0eXAiOiJhcHBsaWNhdGlvbi9kaWRjb21tLWVuY3J5cHRlZCtqc29uIn0',
            recipients: [
              {
                header: {
                  kid: 'did:nuggets:sZziFvdXw8siMvg1P4YS91gG4Lc#key-p256-1',
        ...
        it("and `enc` = 'A192GCM'", async () => {
          const jwe = {
            protected: 'eyJhbGciOiJFQ0RILUVTK0ExOTJLVyIsImVuYyI6IkExOTJHQ00iLCJ0eXAiOiJhcHBsaWNhdGlvbi9kaWRjb21tLWVuY3J5cHRlZCtqc29uIn0',
            recipients: [
              {
                header: {
                  kid: 'did:nuggets:sZziFvdXw8siMvg1P4YS91gG4Lc#key-p256-1',
        ...
        it("and `enc` = 'A256GCM'", async () => {
          const jwe = {
            protected: 'eyJhbGciOiJFQ0RILUVTK0EyNTZLVyIsImVuYyI6IkEyNTZHQ00iLCJ0eXAiOiJhcHBsaWNhdGlvbi9kaWRjb21tLWVuY3J5cHRlZCtqc29uIn0',
            recipients: [
              {
                header: {
                  kid: 'did:nuggets:sZziFvdXw8siMvg1P4YS91gG4Lc#key-p256-1',
      ...
      describe('where enc type is `CBC`', () => {
        ...
        it('and enc=`A128CBC-HS256`', async () => {
          const jwe = {
            protected: 'eyJhbGciOiJFQ0RILUVTK0ExMjhLVyIsImVuYyI6IkExMjhDQkMtSFMyNTYiLCJ0eXAiOiJhcHBsaWNhdGlvbi9kaWRjb21tLWVuY3J5cHRlZCtqc29uIn0',
            recipients: [
              {
                header: {
                  kid: 'did:nuggets:sZziFvdXw8siMvg1P4YS91gG4Lc#key-p256-1',
        ...
        it('and enc=`A192CBC-HS384`', async () => {
          const jwe = {
            protected: 'eyJhbGciOiJFQ0RILUVTK0ExOTJLVyIsImVuYyI6IkExOTJDQkMtSFMzODQiLCJ0eXAiOiJhcHBsaWNhdGlvbi9kaWRjb21tLWVuY3J5cHRlZCtqc29uIn0',
            recipients: [
              {
                header: {
                  kid: 'did:nuggets:sZziFvdXw8siMvg1P4YS91gG4Lc#key-p256-1',
        ...
        it('and enc=`A256CBC-HS512`', async () => {
          const jwe = {
            protected: 'eyJhbGciOiJFQ0RILUVTK0EyNTZLVyIsImVuYyI6IkEyNTZDQkMtSFM1MTIiLCJ0eXAiOiJhcHBsaWNhdGlvbi9kaWRjb21tLWVuY3J5cHRlZCtqc29uIn0',
            recipients: [
              {
                header: {
                  kid: 'did:nuggets:sZziFvdXw8siMvg1P4YS91gG4Lc#key-p256-1',
                ...
                encrypted_key: 'nls1fK_x25dCe4DBb_pqja2J_fCVvwFqXp3IAeRWuxzpulGvPcD3Tv1OJmovCZtUkSUPRI5PXBDekYDaV9ToZcAkXd49x-HH'
              }
            ],
