    ...
    describe('should encrypt plaintext correctly', () => {
      ...
      describe('where enc type is `GCM`', () => {
        ...
        it("and `enc` = 'A128GCM'", async () => {
          ...
          expect(jwe.protected).toEqual("eyJhbGciOiJFQ0RILUVTK0ExMjhLVyIsImVuYyI6IkExMjhHQ00iLCJ0eXAiOiJhcHBsaWNhdGlvbi9kaWRjb21tLWVuY3J5cHRlZCtqc29uIn0")
        ...
        it("and `enc` = 'A192GCM'", async () => {
          ...
          expect(jwe).toBeInstanceOf(Object)
          expect(Object.keys(jwe).sort()).toEqual([ 'ciphertext', 'iv', 'protected', 'recipients', "tag" ])
          expect(jwe.protected).toEqual("eyJhbGciOiJFQ0RILUVTK0ExOTJLVyIsImVuYyI6IkExOTJHQ00iLCJ0eXAiOiJhcHBsaWNhdGlvbi9kaWRjb21tLWVuY3J5cHRlZCtqc29uIn0")
          expect(jwe.recipients[0].header.kid).toBe(jwks[0].public.kid)
        });
        ...
        it("and `enc` = 'A256GCM'", async () => {
          ...
          expect(jwe).toBeInstanceOf(Object)
          expect(Object.keys(jwe).sort()).toEqual([ 'ciphertext', 'iv', 'protected', 'recipients', "tag" ])
          expect(jwe.protected).toEqual("eyJhbGciOiJFQ0RILUVTK0EyNTZLVyIsImVuYyI6IkEyNTZHQ00iLCJ0eXAiOiJhcHBsaWNhdGlvbi9kaWRjb21tLWVuY3J5cHRlZCtqc29uIn0")
          expect(jwe.recipients[0].header.kid).toBe(jwks[0].public.kid)
        });
      ...
      describe('where enc type is `CBC`', () => {
        ...
        it('and enc=`A128CBC-HS256`', async () => {
          ...
          expect(jwe).toBeInstanceOf(Object)
          expect(Object.keys(jwe).sort()).toEqual([ 'ciphertext', 'iv', 'protected', 'recipients', "tag" ])
          expect(jwe.protected).toEqual("eyJhbGciOiJFQ0RILUVTK0ExMjhLVyIsImVuYyI6IkExMjhDQkMtSFMyNTYiLCJ0eXAiOiJhcHBsaWNhdGlvbi9kaWRjb21tLWVuY3J5cHRlZCtqc29uIn0")
          expect(jwe.recipients[0].header.kid).toBe(jwks[0].public.kid)
        })
        ...
        it('and enc=`A192CBC-HS384`', async () => {
          ...
          expect(jwe).toBeInstanceOf(Object)
          expect(Object.keys(jwe).sort()).toEqual([ 'ciphertext', 'iv', 'protected', 'recipients', "tag" ])
          expect(jwe.protected).toEqual("eyJhbGciOiJFQ0RILUVTK0ExOTJLVyIsImVuYyI6IkExOTJDQkMtSFMzODQiLCJ0eXAiOiJhcHBsaWNhdGlvbi9kaWRjb21tLWVuY3J5cHRlZCtqc29uIn0")
          expect(jwe.recipients[0].header.kid).toBe(jwks[0].public.kid)
        })
        ...
        it('and enc=`A256CBC-HS512`', async () => {
          ...
          expect(jwe).toBeInstanceOf(Object)
          expect(Object.keys(jwe).sort()).toEqual([ 'ciphertext', 'iv', 'protected', 'recipients', "tag" ])
          expect(jwe.protected).toEqual("eyJhbGciOiJFQ0RILUVTK0EyNTZLVyIsImVuYyI6IkEyNTZDQkMtSFM1MTIiLCJ0eXAiOiJhcHBsaWNhdGlvbi9kaWRjb21tLWVuY3J5cHRlZCtqc29uIn0")
          expect(jwe.recipients[0].header.kid).toBe(jwks[0].public.kid)
        })
